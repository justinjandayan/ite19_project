          ...
          <div class="col-md-12">
            ...
            <div class="col-md-12 col-sm-12 mb-3 d-flex justify-content-start align-items-center gap-4">
              ...
              <div class="button-wrapper">
                  ...
                  <input type="file" value="{{ asset('upload/car/' . $getRecord->photo ) }}" class="form-control" name="photo" id="photo" onchange="previewImage(this)">
              ...
              <div >
                @if(!empty($getRecord->getPhotoDirect()))
                      <img src="{{ $getRecord->getPhotoDirect() }}" style="width: auto;height: 100px;">
                    @endif
                </div>
          </div>
