...
<div class="content-wrapper">
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-6" style="text-align:right;">
            <a href="{{ url('admin/cars/add')}}" class="btn btn-primary">Add New Cars</a>
          </div>
  ...
  <div class="btn-group">
    ...
    <div class="dropdown-menu">
      <a class="dropdown-item" href="{{ url('admin/cars/edit/'.$value->id) }}">Edit</a>
      <a class="dropdown-item" href="{{ url('admin/cars/delete/'.$value->id) }}">Delete</a>
    </div>
  </div>
</td>
