...
class User extends Authenticatable
{
    ...
    static public function getTotalCustomer($user_type)
    {
    ...
    static public function getTotalDealer($user_type)
    {
        return self::select('users.id')
                    ->where('user_type','=', 3)
                    ->where('is_delete','=',0)
    ...
    static public function getTotalSupplier($user_type)
    {
        return self::select('users.id')
                    ->where('user_type','=', 4)
                    ->where('is_delete','=',0)
    ...
    static public function getDealer()
    {
        $return = self::select('users.*') 
